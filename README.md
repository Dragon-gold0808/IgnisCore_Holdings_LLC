  ...
  # IgnisCore Holdings LLC Website

  This is the website for IgnisCore Holdings LLC, built with React (TypeScript), Tailwind CSS, and Vite.
  ...
  The build directory contains the complete IgnisCore Holdings LLC website ready for deployment!
